...
import defaultParserInterface from 'astql/languages/html/utils/defaultESTreeParserInterface';
...
export default {
  ...
  loadParser(callback) {
    multipleRequire(['@angular-eslint/template-parser'], wrapParesr.bind(null, callback));
  },
